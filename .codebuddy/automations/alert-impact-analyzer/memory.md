...
2. ✅ 未读 alerts: 4 条
3. ✅ Urgent 级别: 1 条 (蔚来)
4. ✅ Important 级别: 1 条 (美光科技)

### 影响分析结果
- 蔚来 (NIO): bearish, 7/10, 健康度 80→65
- 美光科技 (MU): neutral, 3/10, 健康度 82→65

### 执行摘要
- ✅ 成功完成 2 条 alerts 的影响分析
- ✅ 日志已更新: alert-impact-2026-03-29.md
...
### 执行摘要
- ✅ 成功完成 2 条 alerts 的影响分析
- ✅ 日志已创建: alert-impact-2026-03-30.md
...
1. ✅ 本地服务运行正常 (http://localhost:4000)
2. ✅ 未读 alerts: 4 条
3. ✅ High/Medium 级别: 2 条
   - urgent: 蔚来交付量预警 (NIO)
   - important: 美光科技库存周期 (MU)

### 影响分析结果
- 蔚来 (NIO): bearish, 7/10, 健康度 80→65
- 美光科技 (MU): neutral, 5/10, 健康度 82→65
...
### 影响分析结果
- 蔚来 (NIO): neutral, 5/10, 健康度 80→80 (无变化)
- 美光科技 (MU): neutral, 4/10, 健康度 80→75 (-5)
...
### 影响分析结果
- 蔚来 (NIO): bearish, 7/10, 健康度 80→65 (-15)
- 美光科技 (MU): neutral, 5/10, 健康度 80→75 (-5)

### 执行摘要
- ✅ 成功完成 2 条 alerts 的影响分析
- ✅ 日志已创建: alert-impact-2026-03-31.md
...
### 影响分析结果
- 蔚来 (NIO): bearish, 7/10, 健康度 82→65
- 美光科技 (MU): neutral, 5/10, 健康度 80→65
...
### 影响分析结果
- 蔚来 (NIO): bearish, 7/10, 健康度 82→65 (-17)
- 美光科技 (MU): neutral, 5/10, 健康度 80→75 (-5)
...
### 影响分析结果
- 蔚来 (NIO): bearish, 7/10, 健康度 80→65 (-17)
- 美光科技 (MU): neutral, 3/10, 健康度 80→65 (-15)

### 执行摘要
- ✅ 成功完成 2 条 alerts 的影响分析
- ✅ 日志已更新: alert-impact-2026-03-31.md
...
### 影响分析结果
- 蔚来 (NIO): bearish, 7/10, 健康度 80→65 (-17)
- 美光科技 (MU): neutral, 5/10, 健康度 80→65 (-17)
...
### 影响分析结果
- 蔚来 (NIO): bearish, 7/10, 健康度 80→65 (-15)
- 美光科技 (MU): neutral, 5/10, 健康度 80→65 (-15)
...
### 执行摘要
- ✅ 成功完成 2 条 alerts 的影响分析
- ✅ 日志已创建: alert-impact-2026-04-01.md
...
### 执行摘要
- ✅ 成功完成 2 条 alerts 的影响分析
- ✅ 日志已更新: alert-impact-2026-04-01.md
