...
interface MonitorPlanViewProps {
  thesisId: string
  initialMonitorPlan?: any
}

export default function MonitorPlanView({ thesisId, initialMonitorPlan }: MonitorPlanViewProps) {
  const [monitorPlan, setMonitorPlan] = useState<any>(initialMonitorPlan || null)
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl font-bold">监控计划</h2>
          </div>
